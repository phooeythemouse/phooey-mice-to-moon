        ...
        <div className="grid gap-4 py-4">
          {walletOptions.map((wallet) => (
            <Button
              ...
              className="glass-card bg-space-dark/50 hover:bg-space-blue/20 text-white border border-space-blue/20 rounded-lg p-4 flex items-center justify-between"
              disabled={connecting}
            >
              ...
              {connecting && <div className="loader w-5 h-5 border-2 border-t-space-accent rounded-full animate-spin"></div>}
            </Button>
          ))}
        </div>
